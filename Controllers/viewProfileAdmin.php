...
// Fetch department name (with null check)
...
// Fetch designation name (with null check)
...
<body style="font-family:'Merriweather Sans', sans-serif;">
        ...
        <form id="view-profile-form" method="POST">
            <div class="form-row profile-row">
                <div class="col-md-4 relative">
                    ...
                    <!--<input type="file" class="form-control" name="avatar" id="avatar" style="height:38px;margin-top:5px;padding-top:3px;"accept="image/*">-->
                </div>           
                <div class="col-md-8">
            ...
            <div class="form-row">
                ...
                <!--<div class="col-md-3">
                   ...
                   <input class="form-control" type="password" id="password" name="password" value="<?php echo htmlspecialchars($Password); ?>" readonly >
                </div>-->
                <!--<div class="col-md-3">
                   <label for="password">Password</label>
    ...
    <!--<div class="col-md-3">
        ...
        <input class="form-control" type="password" id="confirm_password" name="confirm_password" value="<?php echo htmlspecialchars($userRole); ?>" readonly>
    </div>-->
